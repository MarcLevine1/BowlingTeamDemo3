// application file for exercise on pages 386 - 391
...
public class BowlingTeamDemo3
{
	public static void main(String[] args)
	{
		...
		// input phase
		// this loop create each individual team for the teams array
		for(y = 0; y < NUM_TEAMS; ++y)
		{
			...
			// this loop will fill all four members or the members array
		...
		// now loop through the array of teams to see if the input matches any team member
